import SortView from '../view/sort-menu';
...
import TripPointEditor from '../view/trip-point-editor';
import {renderElement, RenderPosition, removeView} from '../utils/ui';
import {SortRules, FiltersRules} from '../app-data';
